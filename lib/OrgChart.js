	  ...
	  _createClass(OrgChart, [{
	    ...
	    value: function _removeClass(elements, classNames) {
	      elements.forEach(function (el) {
	        if (classNames.indexOf(' ')) {
	          ...
	          try {
	            for (var _iterator = classNames.split(' ')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	      ...
	      if (!direction || direction && direction !== 'left') {
	        ...
	        try {
	          for (var _iterator8 = nextSibs[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
	            ...
	            try {
	              for (var _iterator9 = _sib.querySelectorAll('.node')[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
	    ...
	    value: function _onDrop(event) {
	      ...
	      if (!dropZone.parentNode.parentNode.nextElementSibling) {
	        ...
	        try {
	          for (var _iterator12 = dragged.querySelectorAll('.horizontalEdge')[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
	            var hEdge = _step12.value;
	    ...
	    value: function _createNode(nodeData, level, opts) {
	      ...
	      return new Promise(function (resolve, reject) {
	        if (nodeData.children) {
	          ...
	          try {
	            for (var _iterator13 = nodeData.children[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {

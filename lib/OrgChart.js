	...
	var OrgChart = function () {
	  ...
	  _createClass(OrgChart, [{
	    ...
	    value: function getNodeState(node, relation) {
	      ...
	      if (relation === 'parent') {
	        target.push(this._closest(node, function (el) {
	    ...
	    value: function hideSiblings(node, direction) {
	      ...
	      try {
	        for (var _iterator4 = siblings[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	          var _sib2 = _step4.value;
	      ...
	      if (!direction || direction && direction === 'left') {
	        ...
	        try {
	          for (var _iterator5 = preSibs[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
	            ...
	            try {
	              for (var _iterator6 = sib.querySelectorAll('.node')[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
	      ...
	      if (!direction || direction && direction !== 'left') {
	        ...
	        try {
	          for (var _iterator7 = nextSibs[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
	            var _sib = _step7.value;
	            var _iteratorNormalCompletion8 = true;
	            var _didIteratorError8 = false;
	            var _iteratorError8 = undefined;
	
	            try {
	              for (var _iterator8 = _sib.querySelectorAll('.node')[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
	      ...
	      try {
	        for (var _iterator9 = this._siblings(nodeContainer)[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
	          var _sib3 = _step9.value;
	      ...
	      try {
	        for (var _iterator10 = animatedNodes[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
	          var _node3 = _step10.value;
	    ...
	    value: function showDescendants(node) {
	      ...
	      this._one(descendants[0], 'transitionend', function (event) {
	        ...
	        if (event.propertyName === 'top') {
	          _this2._removeClass(descendants, 'slide');
	          if (_this2._isInAction(node)) {
	    ...
	    value: function _clickHorizontalEdge(event) {
	      ...
	      if (siblingsState.exist) {
	        ...
	        if (siblings.querySelectorAll('.node').some(function (node) {
	          return _this4._isVisible(node) && node.classList.contains('slide');
	        })) {
	          return;
	        }
	    ...
	    value: function _onDrop(event) {
	      ...
	      if (!dropZone.parentNode.parentNode.nextElementSibling) {
	        ...
	        try {
	          for (var _iterator11 = dragged.querySelectorAll('.horizontalEdge')[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
	            var hEdge = _step11.value;
	    ...
	    value: function _createNode(nodeData, level, opts) {
	      ...
	      return new Promise(function (resolve, reject) {
	        if (nodeData.children) {
	          ...
	          try {
	            for (var _iterator12 = nodeData.children[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {

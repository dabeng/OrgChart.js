	...
	var OrgChart = function () {
	  ...
	  _createClass(OrgChart, [{
	    ...
	    value: function hideSiblings(node, direction) {
	      ...
	      try {
	        for (var _iterator3 = animatedNodes[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	    ...
	    value: function _onDrop(event) {
	      ...
	      if (!dropZone.parentNode.parentNode.nextElementSibling) {
	        ...
	        try {
	          for (var _iterator4 = dragged.querySelectorAll('.horizontalEdge')[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	            var hEdge = _step4.value;
	    ...
	    value: function _createNode(nodeData, level, opts) {
	      ...
	      return new Promise(function (resolve, reject) {
	        if (nodeData.children) {
	          ...
	          try {
	            for (var _iterator5 = nodeData.children[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {

	    ...
	    value: function _buildSiblingNode(chart, nodeData, callback) {
	      ...
	      if (chart.parentNode.nodeName === 'TD') {
	        (function () {
	          ...
	          _this9._buildChildNode.call(_this9, _this9._closest(chart, function (el) {
	            return el.nodeName === 'TABLE';
	          }), nodeData, function () {
	            if (++childCount === newSiblingCount) {
	              (function () {
	                var siblingTds = _this9._closest(chart, function (el) {
	                  return el.nodeName === 'TABLE';
	                }).children[3].children;
	                ...
	                if (existingSibligCount > 1) {
	                  ...
	                  _this9._complementLine(siblingTds[0], siblingCount, existingSibligCount);
	                  _this9._addClass(siblingTds, 'hidden');
	                  ...
	                  chart.parentNode.parentNode.remove();
	                  _this9._complementLine(siblingTds[insertPostion], siblingCount, 1);
	                  var _temp = siblingTds.slice(0, insertPostion);
	
	                  _this9._addClass(_temp, 'hidden');
	                  _this9._addClass(_temp.querySelectorAll('.node'), 'slide-right');
	
	                  var temp2 = siblingTds.slice(insertPostion);
	
	                  _this9._addClass(temp2, 'hidden');
	                  _this9._addClass(temp2.querySelectorAll('.node'), 'slide-left');
	                }
	                callback();
	              })();
	            }
	        ...
	        (function () {
	          ...
	          _this9.buildHierarchy.call(_this9, nodeData, 0, function () {
